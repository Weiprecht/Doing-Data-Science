...
```{r csv_import}
Path <- "D:/University/SMU/Doing Data Science/Chapter1/Creativity.csv"
...
# Data Import from csv
```{r csv_import2}
Path <- "D:/University/SMU/Doing Data Science/Chapter1/BusinessSales.csv"
Example2 = read.csv(Path, header=TRUE)
Example2
# file.choose hangs up every time.
