...
## Control Parameters
```{r}
Path <- "D:/University/SMU/Doing_Data_Science/DDS_repository/Doing-Data-Science/Chapter1/yob2016.txt"
df_yob = read.table(Path, stringsAsFactors = FALSE,header = FALSE,sep = ";")
